  ...
  return (
    <div className='d-flex justify-content-center align-items-center bg-secondary vh-100'>
      <div className="bg-white p-3 rounded w-25">
        ...
        <button type='submit' className='btn btn-success w-100 rouonded-0  '>Login</button>
        <p>Already have an Account ?</p>
        <Link to="/register"  className='btn btn-default border w-100 bg-light rouonded-0 text-decoration-none '>Register</Link>
          </form>
